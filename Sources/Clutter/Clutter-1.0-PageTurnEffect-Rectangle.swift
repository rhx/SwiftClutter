...
public protocol PageTurnEffectProtocol: DeformEffectProtocol {
    ...
    /// Required Initialiser for types conforming to `PageTurnEffectProtocol`
...
public protocol PaintNodeProtocol {
    ...
    /// Required Initialiser for types conforming to `PaintNodeProtocol`
    init(raw: UnsafeMutableRawPointer)
}
...
public protocol PanActionProtocol: GestureActionProtocol {
    ...
    /// Required Initialiser for types conforming to `PanActionProtocol`
    init(raw: UnsafeMutableRawPointer)
}
...
public protocol ParamSpecColorProtocol: GLibObject.ParamSpecProtocol {
    ...
    /// Required Initialiser for types conforming to `ParamSpecColorProtocol`
    init(raw: UnsafeMutableRawPointer)
}
...
public protocol ParamSpecFixedProtocol: GLibObject.ParamSpecProtocol {
    ...
    /// Required Initialiser for types conforming to `ParamSpecFixedProtocol`
    init(raw: UnsafeMutableRawPointer)
}
...
public protocol ParamSpecUnitProtocol: GLibObject.ParamSpecProtocol {
    ...
    /// Required Initialiser for types conforming to `ParamSpecUnitProtocol`
    init(raw: UnsafeMutableRawPointer)
}
...
public protocol PathConstraintProtocol: ConstraintProtocol {
    ...
    /// Required Initialiser for types conforming to `PathConstraintProtocol`
    init(raw: UnsafeMutableRawPointer)
}
...
public protocol PipelineNodeProtocol: PaintNodeProtocol {
    ...
    /// Required Initialiser for types conforming to `PipelineNodeProtocol`
    init(raw: UnsafeMutableRawPointer)
}
...
public protocol PropertyTransitionProtocol: TransitionProtocol {
    ...
    /// Required Initialiser for types conforming to `PropertyTransitionProtocol`
    init(raw: UnsafeMutableRawPointer)
}
