...
These Swift wrappers have been tested with clutter-1.26.2 and 1.26.4 as well as glib-2.56, 2.58, 2.60, 2.62, and 2.64.  They should work with higher versions, but YMMV.  Also make sure you have `gobject-introspection` and its `.gir` files installed.
